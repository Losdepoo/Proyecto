		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 wow fadeInDown text-center">
				  <a title="Pagos Matricula" href="/Proyecto/Administracion/Pagos/pagos-matricula.php"><img  class="rotate" src="../../img/icon/pagos-matricula.png" alt="Generic placeholder image" height="100" width="100"></a>
				  <h3>Pagos Matricula</h3>
				  <p class="lead">Control de los pagos en la matricula.</p>

				  <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				
				<div class="col-sm-6 wow fadeInDown text-center">
				  <a title="Pagos Mensualidades" href="/Proyecto/Administracion/Pagos/pagos-mensualidades.php"><img  class="rotate" src="../../img/icon/pagos-mensualidades.png" alt="Generic placeholder image" height="100" width="100"></a>
