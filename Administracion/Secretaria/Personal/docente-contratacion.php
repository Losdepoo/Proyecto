			  ...
			  <fieldset>
				...
				<div class="form-group">
			      ...
			      <div class="col-lg-10">
			        ...
			        <label for="select" class="col-lg-2 control-label">Cursos a los que impartirá</label>
			        <select class="form-control">
			          ...
			          <option>Primero Diversificado</option>
			          <option>Segundo Diversificado</option>
			          <option>Tercero Diversificado</option>
			        </select>
