...
<body id="home">
    ...
    <div class="container">
      ...
      <div class="col-md-6 col-md-offset-3 text-center wrap_title">
        <h2>Otros Pagos</h2>
        <p class="lead" style="margin-top:0">Qué otros pagos desea realizar?</p>
        <label><input type="checkbox" name="otroPago[]">Libros</label><br>
        <label><input type="checkbox" name="otroPago[]">Uniformes</label><br>
        <label><input type="checkbox" name="otroPago[]">Monogramas</label><br>
