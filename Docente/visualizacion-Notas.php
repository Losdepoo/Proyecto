...
<body id="home">
  ...
  <!-- inicio div Visualizacion de notas -->

  <div id=VisualizacionNotas" class="content-section-b" style="border-top: 0">
    <div class="container">
      ...
      <div class="row">
        ...
        <form class="form-horizontal">
          ...
          <div class="form-group">
            <label for="txtCodEstudiante" class="col-lg-4 control-label">Codigo del Estudiante</label>
            <div class="col-lg-5">
          ...
          <div class="form-group">
              <label for= "txtNomEstudiante" class="col-lg-4 control-label">Nombre del Estudiante</label>
              <div class="col-lg-5">
                <input type="text" class="form-control" id="txtNomEstudiante" placeholder="Ingrese el nombre del estudiante">
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                <select id="slcAsignatura" name="slcAsignatura" class="form-control">
                  <option value="1">ej.; matemáticas</option>
                  <option value="2">ej.; español</option>
                </select>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="input-group">
                <span class="input-group-btn">
                  <button type="submit" class="btn btn-default btn-sm">Nota Total Asignatura</button>
                </span>
                <input id="txtNotaAsignatura" name="txtNotaAsignatura" type="text" placeholder="Automático" class="form-control input-md">
              </div>    
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input id="txtPromedioParcial" name="txtPromedioParcial" type="text" placeholder="Automático" class="form-control input-md">
              </div>    
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input id="txtPromedioFinal" name="txtPromedioFinal" type="text" placeholder="Automático" class="form-control input-md">   
              </div>    
            </div>
          </div>
        </form> 
...
<!-- fin div Visualizacion de notas -->
